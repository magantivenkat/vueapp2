using System;
using GoRegister.Framework.Security.Middleware.Constants;
using GoRegister.Security.Middleware.Constants;

namespace GoRegister.Security.Middleware
{
    /// <summary>
    ...
    public class SecurityHeadersBuilder
    {
        ...
        public SecurityHeadersBuilder AddDefaultSecurePolicy()
        {
            ...
            AddStrictTransportSecurityMaxAgeIncludeSubDomainsPreload();
            RemoveServerHeader();
        ...
        /// Tells the user-agent to cache the domain in the STS list for the number of seconds provided and include any sub-domains.
        /// </summary>
        public SecurityHeadersBuilder AddStrictTransportSecurityMaxAgeIncludeSubDomainsPreload(int maxAge = OneYearInSeconds)
        {
            _policy.SetHeaders[StrictTransportSecurityConstants.Header] =
                string.Format(StrictTransportSecurityConstants.MaxAgeIncludeSubdomainsPreload, maxAge);
            return this;
        }
        ...
        {                        
            _policy.SetHeaders[ContentSecurityOptionsConstants.Header] = ContentSecurityOptionsConstants.Value;
            return this;
        }
    }
}