namespace GoRegister.Security.Middleware.Constants
{
    /// <summary>
    ...
    public static class StrictTransportSecurityConstants
    {
        ...
        /// <summary>
        /// Tells the user-agent to cache the domain in the STS list for the provided number of seconds {0}, include any sub-domains and preload.
        /// </summary>
        public static readonly string MaxAgeIncludeSubdomainsPreload = "max-age={0}; includeSubDomains; preload";
