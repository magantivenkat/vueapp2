...
if (docCookies.hasItem("sidebarstate")) {
    ...
    document.getElementsByTagName('body').addClass(docCookies.getItem("sidebarstate"));
}
...
function setupSearch(selector) {
    var searchUrl = document.querySelector(selector).getAttribute("data-search-url")
    new Autocomplete(selector, {
        search: input => {
            return new Promise(resolve => {
                ...
                fetch(searchUrl + "?value=" + encodeURI(input))
...
//var gradmin = (function (Vue) {
//    var mixins = [];
//    var app;

//    var addPageMixin = function (pageMixin) {
