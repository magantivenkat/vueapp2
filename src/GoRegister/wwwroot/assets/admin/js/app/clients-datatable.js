                ...
                //{ data: "registrationStatus" },
                {
                    ...
                    "render": function (clientId, type, full, meta) {
                       //<a href="${ actionUrl }Details/${delegateId}" class="btn btn-info btn-sm">Details</a>
                        //<button type="button" onclick="DeleteRow(${clientId}, '${full.name}', '${actionUrl}')" class="btn btn-danger btn-sm">Delete</button>
                        return `
                                <a href="/admin/Client/Edit?id=${clientId}" class="btn btn-primary btn-sm">Edit</a>
