    ...
    public static class CancelRegistration
    {
        ...
        public class Handler : IRequestHandler<Command, Result<Unit>>
        {
            ...
            public async Task<Result<Unit>> Handle(Command request, CancellationToken cancellationToken)
            {
                ...
                var formModel = await _formService.GetCancellationForm();
                ...
                if (delegateUser.RegistrationStatusId != (int)RegistrationStatus.Confirmed)
                {
                ...
                {
                    return Result.Invalid<Unit>("Users can no longer cancel their registrations for this event");
                }
                ...
                delegateUser.CancellationDocument = serializedForm;
                delegateUser.ChangeRegistrationStatus(RegistrationStatus.Cancelled);
                ...
                await _publisher.Publish(new DelegateCancelledRegistrationEvent(delegateUser));
