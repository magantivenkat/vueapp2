...
namespace GoRegister.ApplicationCore.Framework.DataTables
{
    public class DataTables
    {
        ...
        public class DtParameters
        {
            ...
            public string SortOrder => Columns != null && Order != null && Order.Length > 0
                ? (Columns[Order[0].Column].Data +
                   (Order[0].Dir == DtOrderDirection.DESC ? " " + Order[0].Dir : string.Empty))
                : null;
        ...
        public class DtOrder
        {
            ...
            /// </summary>
            public DtOrderDirection Dir { get; set; }
        }
