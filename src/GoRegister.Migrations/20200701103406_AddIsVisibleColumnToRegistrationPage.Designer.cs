...
namespace GoRegister.Migrations
{
    ...
    [Migration("20200701103406_AddIsVisibleColumnToRegistrationPage")]
    partial class AddIsVisibleColumnToRegistrationPage
    {
            ...
            modelBuilder.Entity("GoRegister.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "c551f914-69a0-4ccc-a82d-1b99a36547e8",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEM4rzyxJTku+AaPxAXxzS+WSmts/Q82B9FKMyO3YUXbYdNnfKy5CyB8mNeylMiiGOg==",
            ...
            modelBuilder.Entity("GoRegister.Data.Models.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "78bf2202-bf6b-4361-be8c-fb450f0796be",
                            Name = "Administrator",
            ...
            modelBuilder.Entity("GoRegister.Data.Models.RegistrationPage", b =>
                {
                    ...
                    b.HasOne("GoRegister.Data.Models.ProjectPage", "ProjectPage")
                        .WithOne("RegistrationPage")
                        .HasForeignKey("GoRegister.Data.Models.RegistrationPage", "ProjectPageId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
