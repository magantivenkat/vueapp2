...
{
    public partial class updatespusersessions : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            var sp = @"ALTER PROCEDURE usp_GetUserSessions
	-- Add the parameters for the stored procedure here. Altering SP as new column meeting link is to be returned.
	@UserId INT,
	@ProjectId INT
AS
BEGIN
	...
	select 
		...
		sess.MeetingLink as MeetingLink,
