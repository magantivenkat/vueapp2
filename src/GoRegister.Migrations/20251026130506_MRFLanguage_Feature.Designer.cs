...
namespace GoRegister.Migrations
{
    ...
    [Migration("20251026130506_MRFLanguage_Feature")]
    partial class MRFLanguage_Feature
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoRegister.ApplicationCore.Data.Models.Field", b =>
                {
                    ...
                    b.Property<bool?>("EnableApproval")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("GoRegister.ApplicationCore.Data.Models.Language", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GoRegister.ApplicationCore.Data.Models.MRFApprovalActionDetails", b =>
                {
                    b.Property<int>("MRFActionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("MRFActionId"), 1L, 1);
                    ...
                    b.Property<int>("MRFClinetResponseId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("MRFActionId");

                    b.ToTable("MRFApprovalActionDetails");
                });

            modelBuilder.Entity("GoRegister.ApplicationCore.Data.Models.MRFApprovalRuleDetails", b =>
                {
                    b.Property<int>("MRFApprovalId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("MRFApprovalId"), 1L, 1);

                    b.Property<int>("ApprovalFieldId")
                        .HasColumnType("int");

                    b.Property<string>("ApprovalRuleDetails")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ApproverEmailIds")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasKey("MRFApprovalId");

                    b.HasIndex("ProjectId");

                    b.ToTable("MRFApprovalRuleDetails");
                });
            ...
            modelBuilder.Entity("GoRegister.ApplicationCore.Data.Models.MRFClientRequest", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ClientuniqueID"), 1L, 1);
            ...
            modelBuilder.Entity("GoRegister.ApplicationCore.Data.Models.MRFLanguage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("MRFLanguage");
                });

            modelBuilder.Entity("GoRegister.ApplicationCore.Data.Models.MRFLanguageResource", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("LanguageResource")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("MRFLanguageId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MRFLanguageId");

                    b.ToTable("MRFLanguageResource");
                });

            modelBuilder.Entity("GoRegister.ApplicationCore.Data.Models.MRFServiceCountryMapping", b =>
                {
                    b.Property<int>("MappingCountryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("MappingCountryId"), 1L, 1);
                    ...
                    b.Property<string>("RequestCountryId")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ServiceCountry")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ServiceCountryUuid")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("MappingCountryId");

                    b.HasIndex("ProjectId");

                    b.ToTable("MRFServiceCountryMapping");
                });
            ...
            modelBuilder.Entity("GoRegister.ApplicationCore.Data.Models.Fields.MRFRequestorCountryField", b =>
                {
                    b.HasBaseType("GoRegister.ApplicationCore.Data.Models.Field");
            ...
            modelBuilder.Entity("GoRegister.ApplicationCore.Data.Models.DelegateUser", b =>
                {
                    ...
                    b.Navigation("ParentDelegateUser");
            ...
            modelBuilder.Entity("GoRegister.ApplicationCore.Data.Models.FieldOptionRule", b =>
                {
                    ...
                    b.Navigation("NextField");

                    b.Navigation("NextFieldOption");
            ...
            modelBuilder.Entity("GoRegister.ApplicationCore.Data.Models.MRFClientRequestCountry", b =>
                {
                    ...
                    b.Navigation("MRFClientRequest");
                });

            modelBuilder.Entity("GoRegister.ApplicationCore.Data.Models.MRFLanguage", b =>
                {
                    b.HasOne("GoRegister.ApplicationCore.Data.Models.Language", "Language")
                        .WithMany("MRFLanguages")
            ...
            modelBuilder.Entity("GoRegister.ApplicationCore.Data.Models.MRFLanguageResource", b =>
                {
                    ...
                    b.HasOne("GoRegister.ApplicationCore.Data.Models.MRFLanguage", "MRFLanguage")
                        .WithMany("MRFLanguageResources")
                        .HasForeignKey("MRFLanguageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Field");

                    b.Navigation("MRFLanguage");
                });
            ...
            modelBuilder.Entity("GoRegister.ApplicationCore.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.Navigation("UserProjectMapping");
                });
            ...
            modelBuilder.Entity("GoRegister.ApplicationCore.Data.Models.Client", b =>
                {
                    ...
                    b.Navigation("TPNCountryAdminMappings");

                    b.Navigation("TPNCountryClientEmails");
                });

            modelBuilder.Entity("GoRegister.ApplicationCore.Data.Models.CustomPage", b =>
                {
                    b.Navigation("CustomPageAudits");

                    b.Navigation("CustomPageRegistrationStatuses");

                    b.Navigation("CustomPageRegistrationTypes");

                    b.Navigation("CustomPageVersions");
            ...
            modelBuilder.Entity("GoRegister.ApplicationCore.Data.Models.CustomPageAudit", b =>
                {
                    b.Navigation("CustomPageAuditRegistrationTypes");
                });
            ...
            modelBuilder.Entity("GoRegister.ApplicationCore.Data.Models.DelegateUser", b =>
                {
                    ...
                    b.Navigation("DelegateSessionBookings");

                    b.Navigation("UserFormResponses");
                });

            modelBuilder.Entity("GoRegister.ApplicationCore.Data.Models.DelegateUserAudit", b =>
                {
                    b.Navigation("UserFieldResponseAudits");
                });
            ...
            modelBuilder.Entity("GoRegister.ApplicationCore.Data.Models.EmailAudit", b =>
                {
                    b.Navigation("EmailAuditNotifications");
                });
            ...
            modelBuilder.Entity("GoRegister.ApplicationCore.Data.Models.Field", b =>
                {
                    b.Navigation("FieldOptionRules");

                    b.Navigation("FieldOptions");

                    b.Navigation("RegistrationTypeFields");

                    b.Navigation("UserFieldResponseAudits");

                    b.Navigation("UserFieldResponses");
                });
            ...
            modelBuilder.Entity("GoRegister.ApplicationCore.Data.Models.FieldOption", b =>
                {
                    ...
                    b.Navigation("NextFieldOptionRules");
            ...
            modelBuilder.Entity("GoRegister.ApplicationCore.Data.Models.Form", b =>
                {
                    b.Navigation("RegistrationPages");
                });

            modelBuilder.Entity("GoRegister.ApplicationCore.Data.Models.Language", b =>
                {
                    b.Navigation("MRFLanguages");
                });

            modelBuilder.Entity("GoRegister.ApplicationCore.Data.Models.MenuItem", b =>
                {
                    b.Navigation("MenuItemRegistrationTypes");
                });

            modelBuilder.Entity("GoRegister.ApplicationCore.Data.Models.MRFClientRequest", b =>
                {
                    b.Navigation("MRFClientRequestCountry");
                });

            modelBuilder.Entity("GoRegister.ApplicationCore.Data.Models.MRFLanguage", b =>
                {
                    b.Navigation("MRFLanguageResources");
                });
            ...
            modelBuilder.Entity("GoRegister.ApplicationCore.Data.Models.Project", b =>
                {
                    ...
                    b.Navigation("ProjectThemes");

                    b.Navigation("RecentProjects");

                    b.Navigation("RegistrationPaths");
            ...
            modelBuilder.Entity("GoRegister.ApplicationCore.Data.Models.RegistrationPage", b =>
                {
                    ...
                    b.Navigation("RegistrationPageRegistrationTypes");
                });
            ...
            modelBuilder.Entity("GoRegister.ApplicationCore.Data.Models.RegistrationType", b =>
                {
                    ...
                    b.Navigation("DelegateUsers");

                    b.Navigation("RegistrationPageRegistrationTypes");

                    b.Navigation("RegistrationTypeFields");

                    b.Navigation("SessionRegistrationTypes");
                });

            modelBuilder.Entity("GoRegister.ApplicationCore.Data.Models.Session", b =>
                {
                    b.Navigation("AnonSessionBookings");
            ...
            modelBuilder.Entity("GoRegister.ApplicationCore.Data.Models.SessionCategory", b =>
                {
                    b.Navigation("SessionFieldCategories");
